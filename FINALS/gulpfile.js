...
//     var spriteData = 
//         gulp.src('src/img/steps/all_img/*.*') // путь, откуда берем картинки для спрайта
//             .pipe(spritesmith({
//                 imgName: 'sprite2.jpg',
//                 cssName: '_sprite2.css',
//             }));

//     spriteData.img.pipe(gulp.dest('src/img/steps/')); // путь, куда сохраняем картинку
//     spriteData.css.pipe(gulp.dest('src/css/scss/')); // путь, куда сохраняем стили
// });
